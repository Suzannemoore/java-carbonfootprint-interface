...
{
    //set to zero
    double WattBuilding = 0;

    public String getCarbonFootprint() 
    {
        //get the wattbuilding power
        double power = (WattBuilding * 0.9);

        //show out the watt building power
        return "Power for a building is " + power + " carbon footprint";
 
    }
    
    //make public 
    public Building(double WattBuilding) 
    {
        this.WattBuilding = WattBuilding;
